...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "points": "分",
        "separator": "分隔符",
        "dimensions_selected": "已选择 {selected}/{total} 个维度",
        "mode_created_success": "模式 '{mode_key}' 已成功创建！",
        "mode_overwrite_confirm": "模式 '{mode_key}' 已存在，是否覆盖？",
        "dimensions_added_success": "成功添加 {count} 个维度！",
    },
    "en": {
        # Window titles
        ...
        "ai_mode_guide": "Describe your literature screening needs in natural language. Include: research field, features to judge, information to extract, etc.",
        "ai_dimension_guide": "Describe the information you want to extract from literature. Include: research characteristics, numerical data, classifications, evaluations, etc.",
        "describe_your_needs": "Describe your needs:",
        "generate_config": "Generate Config",
        "generate_dimensions": "Generate Dimensions",
        "generating": "AI is generating configuration, please wait...",
        ...
        "points": "pts",
        "separator": "Separator",
        "dimensions_selected": "Selected {selected}/{total} dimensions",
        "mode_created_success": "Mode '{mode_key}' created successfully!",
        "mode_overwrite_confirm": "Mode '{mode_key}' already exists. Overwrite?",
        "dimensions_added_success": "Successfully added {count} dimensions!",
    }
}
