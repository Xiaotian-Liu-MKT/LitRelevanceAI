...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "add_mode": "添加模式",
        "delete_mode": "删除模式",
        "delete_mode_confirm": "确定要删除模式 '{mode}' 吗？此操作不可撤销。",
        "mode_deleted": "模式已删除",
        "cannot_delete_last_mode": "无法删除最后一个模式",
        "no_mode_selected": "请先选择一个模式",
        "log_label": "日志:",
        "preview_label": "预览:",
    ...
    "en": {
        ...
        "delete_mode_confirm": "Are you sure you want to delete mode '{mode}'? This cannot be undone.",
        "mode_deleted": "Mode deleted",
        "cannot_delete_last_mode": "Cannot delete the last mode",
        "no_mode_selected": "Please select a mode first",
        "log_label": "Log:",
